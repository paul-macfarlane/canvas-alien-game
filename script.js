window.addEventListener('load', function (){
    ...
    class Particle {
        constructor(game, x, y) {
            ...
            this.markedForDeletion = false
            this.angle = 0
            this.velecityOfAngle = Math.random() * 0.2 - 0.1
            this.bounced = 0
            this.bottomBounceBoundary = Math.random() * 80 + 60
        }
        update(){
            this.angle += this.velecityOfAngle
    ...
    class UI {
        ...
        draw(context){
            ...
            if (this.game.gameOver){
                ...
                context.fillText(message1, this.game.width * .5, this.game.height * 0.5 - 20)
                context.font = '25px ' + this.fontFamily
                context.fillText(message2, this.game.width * .5, this.game.height * 0.5 + 20)
            }
            // ammo
    ...
    class Game {
        ...
        update(deltaTime){
            ...
            if (this.ammoTimer > this.ammoInterval){
                if (this.ammo < this.maxAmmo && !this.gameOver) this.ammo++
                this.ammoTimer = 0
            } else {
